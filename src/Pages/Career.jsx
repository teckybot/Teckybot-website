      ...
      <div className='w-[80%] my-16 rounded-[20px] pb-4 text-center'
        ...
        <div className="flex justify-center items-center">
          <div className='h-[500px] w-[90%] z-20 bg-contain flex flex-col items-center'
            ...
            <p className='px-4 py-4'>Join our team to contribute significantly to our collaborative progress in technological innovation and professional development. At Teckybot, we foster a Positive and Radiant atmosphere where innovation not only survives but flourishes, refining your skills for triumphant success. </p>
