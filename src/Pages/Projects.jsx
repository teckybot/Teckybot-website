...
import hero from '../data/services/projects_hero.png'
...
const Projects = () => {
    ...
    const images = [
        { src: maini1, alt: "Main vertical image", className: "row-span-2" },  // Left large
        { src: i2, alt: "Top right wide image", className: "col-span-2" }, // Top right
        { src: i3, alt: "Bottom right left", className: "" },             // Bottom right 1
            ...
            <div className="max-w-6xl mx-auto p-4 mb-14">
                <div className="grid grid-cols-3 grid-rows-2 gap-4 sm:h-[600px]">
                    {[
                        ...
                        {
                            src: images2[2], // Right tall image
                            alt: "Image 4",
                            className: "col-span-1 row-span-1",
                        },
                    ].map((img, index) => (
